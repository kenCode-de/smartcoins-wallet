...
public enum Coin implements Serializable{
    BITCOIN("BTC",8,6,R.mipmap.coin_icon_btc), BITCOIN_TEST("BTC",8,6,R.mipmap.coin_icon_btc), LITECOIN("LTC",8,6,R.mipmap.ic_launcher), DASH("DASH",8,6,R.mipmap.coin_icon_dash), DOGECOIN("DOGE",8,6,R.mipmap.ic_launcher), BITSHARE("BTS",8,6,R.mipmap.coin_icon_bitshare);

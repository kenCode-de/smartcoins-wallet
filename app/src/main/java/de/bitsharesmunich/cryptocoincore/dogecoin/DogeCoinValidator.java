...
public class DogeCoinValidator extends GeneralCoinValidator {
    ...
    private final static String uriStart = "dogecoin:";
    ...
    static private DogeCoinValidator instance = null;
    ...
    public static DogeCoinValidator getInstance() {
        if (DogeCoinValidator.instance == null) {
            DogeCoinValidator.instance = new DogeCoinValidator();
        }

        return DogeCoinValidator.instance;
    }

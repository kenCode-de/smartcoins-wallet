...
abstract class InsightApiConstants {
     ...
     */
    static{
        //serverAddressPort.put(Coin.BITCOIN,new AddressPort("fr.blockpay.ch",3002,"node/btc/insight-api"));
        ...
        serverAddressPort.put(Coin.LITECOIN,new AddressPort("fr.blockpay.ch",3004,"node/litecoin","insight-api"));
